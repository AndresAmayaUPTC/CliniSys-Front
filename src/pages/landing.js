      ...
      <nav className="navbar navbar-expand-lg navbar-light fixed-top bg-white">
        <div className="container-fluid px-4">
          ...
          <div className="d-none d-lg-flex gap-4">
            <Link to="/about" className="text-decoration-none text-muted">SOBRE NOSOTROS</Link>
            <Link to="/services" className="text-decoration-none text-muted">SERVICIOS</Link>
            <Link to="/contact" className="text-decoration-none text-muted">CONTACTO</Link>
          </div>
          ...
          <div className="col-lg-6 p-5 p-lg-6 position-relative" style={{ zIndex: 1 }}>
            <div className="mx-auto" style={{ maxWidth: '600px' }}>
              ...
              <div className="mt-5 d-flex gap-4">
                <div>
                  <h3 className="h2 text-primary mb-0">+1000</h3>
                  <p className="text-muted">Clínicas</p>
                </div>
                <div>
                  <h3 className="h2 text-primary mb-0">+5000</h3>
                  <p className="text-muted">Médicos</p>
                </div>
                <div>
                  <h3 className="h2 text-primary mb-0">+50k</h3>
      ...
      <div className="container position-relative" style={{ marginTop: '-100px', zIndex: 2 }}>
        <div className="row g-4">
          ...
          <div className="col-md-4">
            <div className="card border-0 shadow-lg">
              <div className="card-body p-4">
                <h4 className="text-primary mb-3">Soporte Premium</h4>
